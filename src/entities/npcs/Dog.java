...
public class Dog extends NPC {
     ...
     */
    public Dog(Handler handler, float x, float y, final int movement_id, String name) {
     ...
     */
    public Dog(Handler handler, float x, float y, final int movement_id) {
        super(handler,x, y, Tile.TILEWIDTH-20, Tile.TILEHEIGHT,movement_id);
        setBoundsOffset(boundsX,boundsY,boundsWidth,boundsHeight);
        this.setHealth(health);
        this.setSpeed(speed);
    ...
    public BufferedImage getInteractFace() {
        return Assets.interactionDog;
    }
}
